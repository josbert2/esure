		...
		while($datos = $stmt->fetch()){
			$cabecera .="<li data-target=\"#myCarousel\" data-slide-to=\"$cnt\"".($cnt == 0 ? " class=\"active\"":"")."></li>";
			 ...
			 $imagenes .= "<div ".($cnt == 0 ? " class=\"item active\"":" class=\"item\"").">".
							 "<img src=\"/modules_/imno/descargar_imagen.php?id_imagen=".$datos["id"]."&dataName=$_SESSION[db_name]\" style=\"width:".($datos["vertical"]==1 ? 280:500)."\">".
							"</div>";
			...
			$arrayRta["cnt_NO_preferenciales"] .="<div class=\"owl-item\" style=\"swidth: 240px;\">".
														"<div class=\"properties\">".
															"<div class=\"image-holder\">".
																"<img src=\"/modules_/imno/descargar_imagen.php?id_imagen=".$id_imagen."\" class=\"img-responsive\" alt=\"properties\">".
																"<div class=\"status sold\">ID: $id_propiedad ".$operacion."</div>".
															"</div>".
															"<h4>".
																"<a target=\"_blank\" href=\"/modules_/imno/detalle_publico_propiedad.php?id=$id_propiedad\">".$direccion."</a>".
															"</h4>".
															"<p class=\"price\">".$importe_operacion."</p>".
															"<a class=\"btn btn-esecure\" target=\"_blank\"  href=\"/modules_/imno/detalle_publico_propiedad.php?id=$id_propiedad\">Ver Detalles</a>".
														"</div>".
													"</div>";
	...
	if($registros > 0){
		...
		while($row = $stmt->fetch()) {		
			...
			if($id_imagen > 0){
				...
				$descripcion_01 = $row["dormitorios"]. " dormitorios -  $operacion";
				$comentario		 = $row["comentario"];
				$urlPublica  	 = "$_SESSION[INMO_URL]/modules_/imno/detalle_publico_propiedad.php?id=$row[id]";
